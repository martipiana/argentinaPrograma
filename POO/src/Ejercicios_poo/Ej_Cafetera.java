...
(la cantidad actual de café que hay en la cafetera). Agregar constructor vacío y con parámetros así como setters y getters. Crear clase CafeteraServicio en el paquete Servicios con los siguiente:
...
public class Ej_Cafetera {
    ...
    public static void main(String[] args) {
        ...
        Cafetera c = serv.llenarCafetera();
        serv.servirTaza(c);
